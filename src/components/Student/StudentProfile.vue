<template>
    <section class="container pt-24 md:px-16">
        ...
        <div class="px-3 ">
            <h1 class="pb-2 text-3xl font-bold text-center md:text-left md:px-24 md:text-5xl">Your Information</h1>
        </div>
            ...
            <div class="p-3 border md:py-9 md:px-9">
                ...
                <div class="py-3">
                    <button class="bg-blue-800 btn btn-block text-gray-50 hover:bg-blue-500"
                        @click="studentAuthStore.changePasswordHandler">Change Password</button>
                </div>
            </div>
        </div>
